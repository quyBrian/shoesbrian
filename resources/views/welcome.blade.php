				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{URL::to('')}}"><img src="{{('public/frontend/images/home/logo.png')}}" alt="" /></a>
						</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a href="{{URL::to('/danh-muc-san-pham/'.$cate_pro->id_category_product)}}">
                                            {{$cate_pro->name_category_product}}
										</a>
									</h4>
								</div>
                                @endforeach
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
                                    @foreach ($brand as $key=>$bra)
                                        <li><a href="{{URL::to('/thuong-hieu/'.$bra->id_brand)}}"> {{$bra->name_brand}} <span class="pull-right">(50)</span></a></li>
                                    @endforeach
